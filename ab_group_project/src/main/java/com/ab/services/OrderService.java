...
public class OrderService {
	...
	public void addOrder(int orderId, OrderType orderType, LocalDateTime dateOfOrder, String stockName, Double buyerPrice, Double sellerPrice, Users user) {
		Orders order = new Orders(orderId, orderType, dateOfOrder, stockName, buyerPrice, sellerPrice, user);
